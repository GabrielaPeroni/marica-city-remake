...
| Security — Pillow 11.3.0 → 12.3.0                            | **Merged** (PR #7) | Fixed 36 of 38 open Dependabot alerts (18 distinct CVEs). Remaining 2 (nltk, black) are dev-tooling, deferred; nltk resolves once PR 3 swaps `safety` for `pip-audit`.                                                                                                                                                                                                                                                                                                                                                        |
